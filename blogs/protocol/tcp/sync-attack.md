---
title: 半连接队列和 SYN Flood 攻击
date: 2018-09-28 14:00:28
sidebar: 'auto'
tags:
  - tcp
categories:
...
三次握手时，服务器第一次收到客户端的 SYN 之后，就会处于 SYN_RCVD 状态，此时双方还没有完全建立其连接，服务器会把此种状态下请求连接放在一个队列里，我们把这种队列称之为半连接队列。
...
:::warning SYN 攻击是一种典型的 DoS/DDoS 攻击。
