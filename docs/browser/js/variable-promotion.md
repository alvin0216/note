---
title: 变量提升：JS 是按顺序执行的吗?
date: 2020-06-14 11:11:30
---

这一节主要讲**执行上下文**只有理解了 `JavaScript` 的执行上下文，你才能更好地理解 JavaScript 语言本身，比如变量提升、作用域和闭包等。不仅如此，理解执行上下文和调用栈的概念还能助你成为一名更合格的前端开发者。
...
![](../../../assets/browser/js/variable-promotion.png)

上面是变量的**声明**和**赋值**，那接下来我们再来看看函数的声明和赋值，结合下面这段代码：
...
// 在代码最后在执行 foo() ---> foo = function(){console.log(2)} --> 2
```
