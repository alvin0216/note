...
在前文React 应用的启动过程中介绍了`React`在启动时会创建全局对象, 其中在创建fiberRoot对象时, 调用[createRootImpl](https://github.com/facebook/react/blob/v17.0.2/packages/react-dom/src/client/ReactDOMRoot.js#L120-L169):
...
![](https://7kms.github.io/react-illustration-series/static/dispatch-event.4c0afc05.png)
重点关注其中 3 个核心环节:
