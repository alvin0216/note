      ...
      '/algorithm/': [
        {
          title: '数据结构',
          collapsable: false,
          children: ['pre-knowledge', 'data-structure/stack', 'data-structure/queue', 'data-structure/stack-queue', 'data-structure/linkedList', 'data-structure/set', 'data-structure/dict-hashtable']
        },
        {
          title: '排序算法',
          collapsable: false,
