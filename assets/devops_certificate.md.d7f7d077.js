...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"></span></code></pre></div><p>最终 <code>nginx -s reload</code>。记得开启 <code>443</code> 端口</p><hr><p>参考 <a href="https://www.cnblogs.com/sage-blog/p/10302934.html" target="_blank" rel="noreferrer">申请 Let&#39;s Encrypt 永久免费 SSL 证书</a></p>`,25),o=[e];function t(c,r,i,y,C,A){return n(),a("div",null,o)}const h=s(p,[["render",t]]);export{d as __pageData,h as default};
