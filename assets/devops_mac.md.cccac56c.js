import{_ as s,o as a,c as n,N as l}from"./chunks/framework.208f6f3f.js";const F=JSON.parse('{"title":"Mac 常用命令","description":"","frontmatter":{"title":"Mac 常用命令","date":"2019-07-15T13:00:28.000Z","sidebar":"auto","tags":["前端工程化"],"categories":["前端工程化"]},"headers":[],"relativePath":"devops/mac.md","lastUpdated":1681197312000}'),p={name:"devops/mac.md"},o=l(`<p>:::: tabs</p><p>::: tab linux 命令</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">lsof</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">-i:4040</span><span style="color:#A6ACCD;"> </span><span style="color:#676E95;font-style:italic;"># 查看 4040 端口占用情况</span></span>
